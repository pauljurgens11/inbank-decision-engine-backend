...
public class DecisionEngineController {
     ...
     */
    @PostMapping
    public DecisionEngineResponse receiveRequestAndRespond(@RequestBody DecisionEngineRequest request) {
        try {
            ...
            response.setLoanAmount(loanInfo[0]);
            response.setLoanPeriod(loanInfo[1]);
            response.setMessage(
